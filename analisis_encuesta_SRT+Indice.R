...
df_indice <- ocupados18_valores %>% 
  select(sector, exig_cogni, acoso_psi, agres_ext, exig_emoc_1, exig_emoc_2, exig_ritmo, recomp_salar, robo_trab, venti, esp_redu, sanit, ruido, vibra, movrep) %>%  
  glimpse()
...
# El sector transporte presenta el mayor riesgo laboral medido a través del índice 
# confeccionado (a más bajos números, mayor frecuencia de indicadores de riesgo)
